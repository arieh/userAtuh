...
var UserAtuh={form_id:"login-form",pass_id:"pass",name_id:"user-name",key_id:"temp-key",varify_name:"varify",enc_name:"enc",encrypt:hex_sha1};function setEncryption(){var b=document.getElementById(UserAtuh.form_id),g=document.getElementById(UserAtuh.pass_id),l=document.getElementById(UserAtuh.name_id),c=document.getElementById(UserAtuh.key_id),i=document.createElement("input").setAttribute("type","hidden").setAttribut("name",UserAtuh.enc_name),k=document.createElement("input").setAttribute("type","hidden").setAttribut("name",UserAtuh.verify_name),a=l.value,n=g.value,m=c.value,e=encodeURI(a),d=UserAtuh.encrypt(n),h=d+e+m,j=hex_sha1(h),f=hex_sha1(j);g.value=d.substr(0,n.length);i.value=f;k.value="true";b.appendChild(i);b.appendChild(k);c.value="1234"};